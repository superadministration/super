...
class ActionMailbox::InboundEmail < ::ActionMailbox::Record
  ...
  class << self
    ...
    # source://activerecord/7.0.7.2/lib/active_record/enum.rb#188
    def statuses; end
...
module ActionMailbox::InboundEmail::GeneratedAssociationMethods
  ...
  # source://activestorage/7.0.7.2/lib/active_storage/attached/model.rb#55
  def raw_email; end

  # source://activestorage/7.0.7.2/lib/active_storage/attached/model.rb#60
