...
class RuboCop::CommentConfig
  ...
  # source://rubocop/1.56.2/lib/rubocop/comment_config.rb#63
  def comment_only_line?(line_number); end

  # source://forwardable/1.3.2/forwardable.rb#229
  def config(*args, &block); end

  # source://rubocop/1.56.2/lib/rubocop/comment_config.rb#51
  def cop_disabled_line_ranges; end

  # source://rubocop/1.56.2/lib/rubocop/comment_config.rb#39
  def cop_enabled_at_line?(cop, line_number); end

  # source://rubocop/1.56.2/lib/rubocop/comment_config.rb#47
  def cop_opted_in?(cop); end

  # source://rubocop/1.56.2/lib/rubocop/comment_config.rb#55
  def extra_enabled_comments; end

  # source://rubocop/1.56.2/lib/rubocop/comment_config.rb#30
  ...
  # source://rubocop/1.56.2/lib/rubocop/comment_config.rb#96
  def analyze; end

  # source://rubocop/1.56.2/lib/rubocop/comment_config.rb#124
  def analyze_cop(analysis, directive); end

  # source://rubocop/1.56.2/lib/rubocop/comment_config.rb#144
  def analyze_disabled(analysis, directive); end

  # source://rubocop/1.56.2/lib/rubocop/comment_config.rb#155
  def analyze_rest(analysis, directive); end

  # source://rubocop/1.56.2/lib/rubocop/comment_config.rb#135
  def analyze_single_line(analysis, directive); end

  # source://rubocop/1.56.2/lib/rubocop/comment_config.rb#164
  def cop_line_ranges(analysis); end

  # source://rubocop/1.56.2/lib/rubocop/comment_config.rb#170
  def each_directive; end

  # source://rubocop/1.56.2/lib/rubocop/comment_config.rb#69
  def extra_enabled_comments_with_names(extras:, names:); end

  # source://rubocop/1.56.2/lib/rubocop/comment_config.rb#190
  def handle_enable_all(directive, names, extras); end

  # source://rubocop/1.56.2/lib/rubocop/comment_config.rb#204
  def handle_switch(directive, names, extras); end

  # source://rubocop/1.56.2/lib/rubocop/comment_config.rb#115
  def inject_disabled_cops_directives(analyses); end

  # source://rubocop/1.56.2/lib/rubocop/comment_config.rb#183
  def non_comment_token_line_numbers; end

  # source://rubocop/1.56.2/lib/rubocop/comment_config.rb#34
  def old_initialize(processed_source); end

  # source://rubocop/1.56.2/lib/rubocop/comment_config.rb#83
  def opt_in_cops; end

  # source://rubocop/1.56.2/lib/rubocop/comment_config.rb#179
...
class RuboCop::Cop::Lint::AssignmentInCondition < ::RuboCop::Cop::Base
  ...
  # source://rubocop/1.56.2/lib/rubocop/cop/lint/assignment_in_condition.rb#55
  def on_if(node); end
  ...
  # source://rubocop/1.56.2/lib/rubocop/cop/lint/assignment_in_condition.rb#82
  def allowed_construct?(asgn_node); end

  # source://rubocop/1.56.2/lib/rubocop/cop/lint/assignment_in_condition.rb#86
  def conditional_assignment?(asgn_node); end

  # source://rubocop/1.56.2/lib/rubocop/cop/lint/assignment_in_condition.rb#90
  def skip_children?(asgn_node); end

  # source://rubocop/1.56.2/lib/rubocop/cop/lint/assignment_in_condition.rb#96
  def traverse_node(node, &block); end
end

# source://standard//lib/standard/rubocop/ext.rb#9
class RuboCop::DirectiveComment
  # source://rubocop/1.56.2/lib/rubocop/directive_comment.rb#30
  def initialize(comment, cop_registry = T.unsafe(nil)); end

  # source://rubocop/1.56.2/lib/rubocop/directive_comment.rb#80
  def all_cops?; end

  # source://rubocop/1.56.2/lib/rubocop/directive_comment.rb#28
  def comment; end

  # source://rubocop/1.56.2/lib/rubocop/directive_comment.rb#85
  def cop_names; end
  ...
  # source://rubocop/1.56.2/lib/rubocop/directive_comment.rb#91
  def department_names; end

  # source://rubocop/1.56.2/lib/rubocop/directive_comment.rb#105
  def directive_count; end

  # source://rubocop/1.56.2/lib/rubocop/directive_comment.rb#60
  def disabled?; end

  # source://rubocop/1.56.2/lib/rubocop/directive_comment.rb#75
  def disabled_all?; end

  # source://rubocop/1.56.2/lib/rubocop/directive_comment.rb#65
  def enabled?; end

  # source://rubocop/1.56.2/lib/rubocop/directive_comment.rb#70
  def enabled_all?; end

  # source://rubocop/1.56.2/lib/rubocop/directive_comment.rb#96
  def in_directive_department?(cop); end

  # source://rubocop/1.56.2/lib/rubocop/directive_comment.rb#110
  def line_number; end

  # source://rubocop/1.56.2/lib/rubocop/directive_comment.rb#42
  def match?(cop_names); end

  # source://rubocop/1.56.2/lib/rubocop/directive_comment.rb#55
  def match_captures; end

  # source://rubocop/1.56.2/lib/rubocop/directive_comment.rb#28
  def mode; end

  # source://rubocop/1.56.2/lib/rubocop/directive_comment.rb#101
  def overridden_by_department?(cop); end

  # source://rubocop/1.56.2/lib/rubocop/directive_comment.rb#46
  def range; end

  # source://rubocop/1.56.2/lib/rubocop/directive_comment.rb#37
  def single_line?; end

  private

  # source://rubocop/1.56.2/lib/rubocop/directive_comment.rb#130
  def all_cop_names; end

  # source://rubocop/1.56.2/lib/rubocop/directive_comment.rb#134
  def cop_names_for_department(department); end

  # source://rubocop/1.56.2/lib/rubocop/directive_comment.rb#126
  def department?(name); end

  # source://rubocop/1.56.2/lib/rubocop/directive_comment.rb#140
  def exclude_redundant_directive_cop(cops); end

  # source://rubocop/1.56.2/lib/rubocop/directive_comment.rb#120
  def parsed_cop_names; end

  # source://rubocop/1.56.2/lib/rubocop/directive_comment.rb#116
  def splitted_cops_string; end

  class << self
    # source://rubocop/1.56.2/lib/rubocop/directive_comment.rb#24
