...
::SUPER_DEFAULT_RAILS = T.let(T.unsafe(nil), String)
::SUPER_DEVELOPMENT_GEMFILE = T.let(T.unsafe(nil), String)
::SUPER_DUMMY_PATH = T.let(T.unsafe(nil), String)
::SUPER_RAILS_ROOTS = T.let(T.unsafe(nil), Hash)
