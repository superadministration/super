...
},{"@stimulus/core":"../node_modules/@stimulus/core/dist/index.js"}],"../node_modules/process/browser.js":[function(require,module,exports) {
...
},{"process":"../node_modules/process/browser.js"}],"javascripts/super/nested_attributes_controller.ts":[function(require,module,exports) {
"use strict";
...
function (_super) {
  ...
  default_1.prototype.add = function (event) {
    event.preventDefault();

    if (this.templateTarget) {
      var unixtime = new Date().getTime();
      var $content = jquery_1.default(this.templateTarget.innerHTML.replace(/TEMPLATE/g, unixtime.toString()));
      var $templateTarget = jquery_1.default(this.templateTarget);
      $templateTarget.before($content);
    }
  };

  default_1.prototype.toggleDestruction = function (event) {
    if (event.target) {
      var $eventTarget = jquery_1.default(event.target);
      var $fieldset = $eventTarget.closest("fieldset");
...
},{"stimulus":"../node_modules/stimulus/index.js","jquery":"../node_modules/jquery/dist/jquery.js"}],"javascripts/super/application.ts":[function(require,module,exports) {
"use strict";
...
var nested_attributes_controller_1 = __importDefault(require("./nested_attributes_controller"));

ujs_1.default.start();
var application = stimulus_1.Application.start();
application.register('nested-attributes', nested_attributes_controller_1.default);
exports.default = {
  StimulusApplication: application,
  StimulusController: stimulus_1.Controller
};
},{"@rails/ujs":"../node_modules/@rails/ujs/lib/assets/compiled/rails-ujs.js","stimulus":"../node_modules/stimulus/index.js","./nested_attributes_controller":"javascripts/super/nested_attributes_controller.ts"}]},{},["javascripts/super/application.ts"], "Super")